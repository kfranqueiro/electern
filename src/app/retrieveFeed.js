"use strict";
define(["dojo/request", "./util"], function (request, util) {
  ...
  const feedHandlers = [
    ...
    },
    {
      ...
      parseArticle: function (element) {
        return {
          id:
            getElementText(element, "guid") ||
            getElementText(element, "identifier") ||
            getElementText(element, "link"), // RSSv1
      ...
      parseMetadata: function (doc) {
        const updated =
          getElementText(doc, "channel > pubDate") ||
