define([
...
], function (_Base, _ParentFolderMixin, modal, i18n, actionsPartial, overridesPartial, parentPartial) {
	return _Base.createSubclass([ _ParentFolderMixin ], {
		...
		_getValueAttr() {
			...
			var selectedParent = Object.keys(this.folderGrid.selection)[0];
		...
		_setValueAttr(value) {
			...
			if (value.feed.parent) {
				this.folderGrid.select(value.feed.parent);
			}
